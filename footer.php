 <!-- Footer Area End Here -->
        <section class="footer_col py-5">
            <div class="container">
                <div class="row h-100">
                    <div class="col-lg-6 my-4 align-self-center">
                        <h3 class="text-white display-6 fw-bold"> <span class="text-danger">Contact Us</span> <br>
                            Have questions or need support?</h3>
                    </div>
                    <div class="col-lg-6 my-4 align-self-center">
                        <div class="bg-white rounded form_box px-3 py-2">
                            ...
                            <div class="row my-5">
                                <div class="col-12">
                                    <button type="button" class="btn btn-danger py-2 w-100">Send</button>
                                </div>
