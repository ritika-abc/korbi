 ...
 <body>
                                     ...
                                     <div class="row">
                                         ...
                                         <div class="col-md-12">
                                             <div class="checkout-form-list">
                                                 ...
                                                 <input placeholder="" id="user_name" name="name" type="text">
                                             </div>
                                         </div>
                                         ...
                                         <div class="col-md-6">
                                             <div class="checkout-form-list">
                                                 ...
                                                 <input placeholder="" id="zip" name="zip" type="text">
                                             </div>
                                         </div>
                                         <!-- <div class="col-md-6">
                                             <div class="checkout-form-list">
                                                         ...
                                                         <tbody>
                                                             <?php
                                                                ...
                                                                ?>
                                                                 ...
                                                                 <input type="hidden" name="user_name" id="user_name" value="<?php echo $row['name']; ?>">
                                                                 <input type="hidden" name="light" id="light" value="<?php echo $row['light']; ?>">
                                                                 <input type="hidden" name="holder" id="holder" value="<?php echo $row['holder']; ?>">
                                                                 <input type="hidden" name="email" id="email" value="<?php echo $row['email']; ?>">
                                                                 <input type="hidden" name="price" id="og_price" value="<?php echo $row['price']; ?>">
                                                 ...
                                                 <div class="row mb-3">
                                                     <div class="col-md-12 ml-auto">
                                                         <div class="cart-page-total">
                                                             ...
                                                             <input type="hidden" id="subtotal" name="subtotal" value="<?php echo $total + $total_discount ?>"> <br>
                                                             <input type="hidden" id="discount" name="discount" value="<?php echo $discount_percentage . '%' ?>"> <br>
                                                             <input type="hidden" id="price" name="price" value="<?php echo $total ?>"> <br>
                                     ...
                                     <div class="payment-method">
                                         <div class="payment-accordion">
                                             ...
                                             <div class="order-button-payment">
                                                 <!-- <input type="button" class="btn btn-dark" id="rzp-button1" onclick="pay_now()"> </input> -->
                                                 <!-- <input type="submit"  name="submit" class="btn btn-dark"  > </input> -->
                                                 <button type="button" class="btn btn-dark w-100" id="rzp-button1" onclick="pay_now()">Pay Now</button>
                                             </div>
                                         </div>
                                     </div>
                                 </div>
     ...
     <script type="text/javascript">
         function pay_now() {
             ...
             var og_price = $("#og_price").val();

             var actual_amount = amount * 100;
 // Validation: check if any required field is empty
        if (  !country || !user_name || !address || !city || !state || !zip || !mobile) {
            ...
            return; // Stop further execution
             ...
             var options = {
                 // "key": "rzp_live_DvJJayK5HngCaq",
                 "key": "rzp_test_xx28KfXBaypeQW",
                 //  "key": "rzp_live_qKPJb5cYzLiG3V",
