                 ...
                 <div class="tromic-offcanvas-body">
                     <div class="minicart-content">
                         <div class="minicart-heading">
                             <h4 class="mb-0">Shopping Cartssss</h4>
                                                ...
                                                ?>
                                                 <tr>
                                                     <td class="product_remove">
                                                         <a href="cart.php?action=remove&product_id=<?php echo $row['product_id']; ?>">
                                                     ...
                                                     <td class="product-thumbnail">
                                                         <a href="#">
                                                             <img src="<?php echo $row['image']; ?>" alt="Cart Thumbnail">
                                                         </a>
                                                     </td>
                                                     ...
                                                     <td class="quantity">
                                                         <div class="cart-plus-minus">
                                                             <input class="cart-plus-minus-box" name="quantity[<?php echo $row['product_id']; ?>]" value="<?php echo $row['quantity']; ?>" type="number" min="1">
                                                         </div>
                                                     </td>
