                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-9 col-lg-8 order-lg-2 order-1">
                            <div class="product-topbar">
                                <ul>
                                    <li class="page-count">
                                        <span>211123</span> Product Found of <span>50</span>
                                    </li>
                            ...
                            <div class="tab-content text-charcoal pt-8">
                                <div class="tab-pane fade show active" id="grid-view" role="tabpanel" aria-labelledby="grid-view-tab">
                                    ...
                                    <div class="product-grid-view row">
                                        ...
                                        $q = "SELECT * FROM `product` limit 6";  // Retrieve 6 products
                                                ...
                                                <form action="cart.php" method="POST">
                                                    <div class="product-item">
                                                        ...
                                                        <div class="product-content">
                                                            <a class="product-name pb-1" href="single-product-variable.html"><?php echo $row['name'] ?></a>
                                                            ...
                                                            <div class="price-box">
                                                                <div class="price-box-holder">
                                                                    <span>Price:</span>
                                                                    <span class="new-price text-primary"><?php echo "$" . $row['price']; ?></span>
                                                                </div>
                                                            </div>
